...
local_full[1,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 1.0 & Relative_Position > 0.899),][,1]),
...
local_full[2,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.9 & Relative_Position > 0.799),][,1]),
...
local_full[3,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.8 & Relative_Position > 0.699),][,1]),
...
local_full[4,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.7 & Relative_Position > 0.599),][,1]),
...
local_full[5,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.6 & Relative_Position > 0.499),][,1]),
...
local_full[6,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.5 & Relative_Position > 0.399),][,1]),
...
local_full[7,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.4 & Relative_Position > 0.299),][,1]),
...
local_full[8,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.3 & Relative_Position > 0.199),][,1]),
...
local_full[9,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.2 & Relative_Position > 0.099),][,1]),
...
local_full[9,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.1 & Relative_Position > 0.000),][,1]),
...
local_full[10,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < 0.0 & Relative_Position > -0.099),][,1]),
...
local_full[11,1:3] <- data.frame(To_1.0_c = median(KMTs_local_Curvature[with(KMTs_local_Curvature, Relative_Position < -0.1 & Relative_Position > -0.199),][,1]),
...
PL <- ggplot(KMTs_local_Curvature, aes(Relative_Position, Curvature)) + 
  geom_smooth(size = 1, method = loess) + 
  xlim(-0.3, 1) + ylim(1, 1.01) +
  theme_classic()
