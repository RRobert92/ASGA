...
KMT_Minus_End_Data_All <- tibble(
  Data = c(
    Interaction_25 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.025, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_30 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.03, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_35 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.035, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_45 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.045, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_50 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.05, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_75 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.075, MT_type == "KMT" | MT_type == "SMT")) /
    ...
    Interaction_100 = mean(c(nrow(filter(Data_1_KMT_Minus_End_0.1, MT_type == "KMT" | MT_type == "SMT")) /
  ...
  STD = c(
    Interaction_25 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.025, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.025),
                            nrow(filter(Data_2_KMT_Minus_End_0.025, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.025),
                            nrow(filter(Data_3_KMT_Minus_End_0.025, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.025))),
    Interaction_30 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.03, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.03),
                            nrow(filter(Data_2_KMT_Minus_End_0.03, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.03),
                            nrow(filter(Data_3_KMT_Minus_End_0.03, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.03))),
    Interaction_35 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.035, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.035),
                            nrow(filter(Data_2_KMT_Minus_End_0.035, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.035),
                            nrow(filter(Data_3_KMT_Minus_End_0.035, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.035))),
    Interaction_45 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.045, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.045),
                            nrow(filter(Data_2_KMT_Minus_End_0.045, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.045),
                            nrow(filter(Data_3_KMT_Minus_End_0.045, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.045))),
    Interaction_50 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.05, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.05),
                            nrow(filter(Data_2_KMT_Minus_End_0.05, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.05),
                            nrow(filter(Data_3_KMT_Minus_End_0.05, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.05))),
    Interaction_75 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.075, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_1_KMT_Minus_End_0.075),
                            nrow(filter(Data_2_KMT_Minus_End_0.075, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_2_KMT_Minus_End_0.075),
                            nrow(filter(Data_3_KMT_Minus_End_0.075, MT_type == "KMT" | MT_type == "SMT")) /
                              nrow(Data_3_KMT_Minus_End_0.075))),
    Interaction_100 = sd(c(nrow(filter(Data_1_KMT_Minus_End_0.1, MT_type == "KMT" | MT_type == "SMT")) /
                               nrow(Data_1_KMT_Minus_End_0.1),
                             nrow(filter(Data_2_KMT_Minus_End_0.1, MT_type == "KMT" | MT_type == "SMT")) /
                               nrow(Data_2_KMT_Minus_End_0.1),
                             nrow(filter(Data_3_KMT_Minus_End_0.1, MT_type == "KMT" | MT_type == "SMT")) /
...
KMT_Minus_End_Data_Pole <- tibble(
  Data = c(
    ...
    Interaction_35 = mean(c(
      nrow(filter(Data_1_KMT_Minus_End_0.035, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.035),
      nrow(filter(Data_2_KMT_Minus_End_0.035, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.035),
      nrow(filter(Data_3_KMT_Minus_End_0.035, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.035)
    )),
    Interaction_45 = mean(c(
      nrow(filter(Data_1_KMT_Minus_End_0.045, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.045),
      nrow(filter(Data_2_KMT_Minus_End_0.045, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.045),
      nrow(filter(Data_3_KMT_Minus_End_0.045, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.045)
    )),
    Interaction_50 = mean(c(
      nrow(filter(Data_1_KMT_Minus_End_0.05, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.05),
      nrow(filter(Data_2_KMT_Minus_End_0.05, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.05),
      nrow(filter(Data_3_KMT_Minus_End_0.05, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.05)
    )),
    Interaction_75 = mean(c(
      nrow(filter(Data_1_KMT_Minus_End_0.075, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.075),
      nrow(filter(Data_2_KMT_Minus_End_0.075, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.075),
      nrow(filter(Data_3_KMT_Minus_End_0.075, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.075)
    )),
    Interaction_100 = mean(c(
      nrow(filter(Data_1_KMT_Minus_End_0.1, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.1),
      nrow(filter(Data_2_KMT_Minus_End_0.1, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.1),
      nrow(filter(Data_3_KMT_Minus_End_0.1, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.1)
    ))
  ),
  Label = c(
  ...
  STD = c(
    Interaction_25 = sd(c(
      nrow(filter(Data_1_KMT_Minus_End_0.025, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.025),
      nrow(filter(Data_2_KMT_Minus_End_0.025, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.025),
      nrow(filter(Data_3_KMT_Minus_End_0.025, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.025)
    )),
    Interaction_30 = sd(c(
      nrow(filter(Data_1_KMT_Minus_End_0.03, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_1_KMT_Minus_End_0.03),
      nrow(filter(Data_2_KMT_Minus_End_0.03, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_2_KMT_Minus_End_0.03),
      nrow(filter(Data_3_KMT_Minus_End_0.03, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
        nrow(Data_3_KMT_Minus_End_0.03)
    )),
    Interaction_35 = sd(c(
      nrow(filter(Data_1_KMT_Minus_End_0.035, MT_type == "KMT" & KMT_Minus_Distance >= 1.53 | MT_type == "SMT" & KMT_Minus_Distance >= 1.53)) /
...
ggplot(KMT_Minus_End_Data_All, aes(Label, weight = Data)) + geom_bar() + theme_classic() + ylim(0, 1) +
...
p1 <- p1 + geom_freqpoly(data = filter(Data_3_KMTs_minus_seed, I_class == "KMT"), aes(Relative_pos),
                         color = "red3")
p1
ggplot(filter(KMT_seed, I_class == "KMT"), aes(Relative_pos)) + geom_histogram(color = "red1") + theme_classic() + ylim(0,100)

p1 <- ggplot(filter(KMT_seed, I_class == "SMT"), aes(Relative_pos)) + geom_freqpoly(color = "orange1") + theme_classic()
...
p1 <- p1 + geom_freqpoly(data = filter(Data_3_KMTs_minus_seed, I_class == "SMT"), aes(Relative_pos),
                         color = "orange3")
p1
ggplot(filter(KMT_seed, I_class == "SMT"), aes(Relative_pos)) + geom_histogram(color = "orange1") + theme_classic() + ylim(0,100)
...
for(i in 1:nrow(Data_2_MT_Interaction_0.045)){
  if(Data_2_MT_Interaction_0.045$Segments_ID_1[i] %in% Segments_KMT_2$`Segment ID`){
    Data_2_MT_Interaction_0.045[i,8] <- "KMT"
  } else {
    Data_2_MT_Interaction_0.045[i,8] <- "SMT"
  }
}
...
coutnter <- 1
for(i in unique(filter(AVG_35, `...8` == "SMT")$Segments_ID_1)){
