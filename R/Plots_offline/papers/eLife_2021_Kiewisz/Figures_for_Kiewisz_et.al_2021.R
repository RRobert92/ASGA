...
###############################################################################
# Combind data for average #
IKD_KMT_avg <- rbind(Data_1_IKD_KMT_No,
                     Data_2_IKD_KMT_No,
                     Data_3_IKD_KMT_No)
...
IKD_KMT_NO <- IKD_KMT_NO +
        geom_point(data = Data_2_IKD_KMT_No, aes(`Inter-kinetochore distance`, `KMTs no.`),
                   color = "brown3", shape = 16, size = 2)
IKD_KMT_NO <- IKD_KMT_NO +
        geom_point(data = Data_3_IKD_KMT_No, aes(`Inter-kinetochore distance`, `KMTs no.`),
...
Correlation <- tibble(
        Data_1 = cor(Data_1_IKD_KMT_No$`Inter-kinetochore distance`,
                     Data_1_IKD_KMT_No$`KMTs no.`),
        Data_2 = cor(Data_2_IKD_KMT_No$`Inter-kinetochore distance`,
                     Data_2_IKD_KMT_No$`KMTs no.`),
        Data_3 = cor(Data_3_IKD_KMT_No$`Inter-kinetochore distance`,
                     Data_3_IKD_KMT_No$`KMTs no.`),
        AVG = cor(IKD_KMT_avg$`Inter-kinetochore distance`,
                  IKD_KMT_avg$`KMTs no.`)
)
...
###############################################################################
# Combind data for average #
IKD_dekta_avg <- rbind(Data_1_IKD_KMT_Delta,
...
IKD_delta_NO <- IKD_delta_NO +
        geom_point(data = Data_2_IKD_KMT_Delta, aes(`Inter-kinetochore distance`, `Delta of KMTs`),
                   color = "brown3", shape = 16, size = 2)
IKD_delta_NO <- IKD_delta_NO +
        geom_point(data = Data_3_IKD_KMT_Delta, aes(`Inter-kinetochore distance`, `Delta of KMTs`),
                   color = "brown4", shape = 17, size = 2)
...
# Analysis of correlations #
Correlation <- tibble(
        Data_1 = cor(Data_1_IKD_KMT_Delta$`Inter-kinetochore distance`,
                     Data_1_IKD_KMT_Delta$`Delta of KMTs`),
        Data_2 = cor(Data_2_IKD_KMT_Delta$`Inter-kinetochore distance`,
                     Data_2_IKD_KMT_Delta$`Delta of KMTs`),
        Data_3 = cor(Data_3_IKD_KMT_Delta$`Inter-kinetochore distance`,
                     Data_3_IKD_KMT_Delta$`Delta of KMTs`),
        AVG = cor(IKD_dekta_avg$`Inter-kinetochore distance`,
...
###############################################################################
# Combind data for average #
LD_avg <- rbind(Data_1_KMTs_minus_seed_0.1,
...
###############################################################################
# Combind data for average #
LD_non_KMTs_avg <- rbind(Data_1_SMT_Ends,
                         Data_1_SMT_Ends,
                         Data_1_SMT_Ends)
...
# Plot #
LD <- ggplot(LD_non_KMTs_avg, aes(Distance_to_Pole)) +
        geom_histogram(bins = 30) +
        theme_classic() +
        ylab("No. of KMTs") +
        xlab("Minus ends distance to the pole [um]")
...
# Plot #
LD <- ggplot(LD_avg, aes(Relativ_Position)) +
        geom_histogram(bins = 30) +
        theme_classic() +
        ylab("No. of KMTs") +
        xlab("Minus ends distance to the pole [um]")
...
Tortuosity_length <- Tortuosity_length +
        geom_point(data = Data_2_KMT_Total_Curv, aes(`KMTs length`, Curvature),
                   shape = 16, color = "brown3")
Tortuosity_length <- Tortuosity_length +
        geom_point(data = Data_3_KMT_Total_Curv, aes(`KMTs length`, Curvature),
                   shape = 17, color = "brown4")
Tortuosity_length <- Tortuosity_length +
        geom_smooth(data = Tortuosity_avg, aes(`KMTs length`, Curvature),
...
Correlation <- tibble(
        Data_1 = cor(Data_1_KMT_Total_Curv$`Curvature`,
                     Data_1_KMT_Total_Curv$`KMTs length`),
        Data_2 = cor(Data_2_KMT_Total_Curv$`Curvature`,
                     Data_2_KMT_Total_Curv$`KMTs length`),
        Data_3 = cor(Data_3_KMT_Total_Curv$`Curvature`,
                     Data_3_KMT_Total_Curv$`KMTs length`),
        AVG = cor(Tortuosity_avg$Curvature,
...
###############################################################################
# Combind data for average #
Tortuosity_local_avg <- rbind(Data_1_KMT_Local_Curv,
...
Tortuosity_local <- Tortuosity_local +
        geom_point(data = Data_2_KMT_Local_Curv, aes(Relative_Position, Curvature),
                   shape = 16, color = "brown3")
Tortuosity_local <- Tortuosity_local +
        geom_point(data = Data_3_KMT_Local_Curv, aes(Relative_Position, Curvature),
                   shape = 17, color = "brown4")
Tortuosity_local <- Tortuosity_local +
        geom_smooth(data = Tortuosity_local_avg, aes(Relative_Position, Curvature),
                    se = F, color = "grey20", size = 2, method = "loess")
...
# Analysis of correlation #
Correlation <- tibble(
        Data_1 = cor(Data_1_KMT_Local_Curv$`Curvature`,
                     Data_1_KMT_Local_Curv$Relative_Position),
        Data_2 = cor(Data_2_KMT_Local_Curv$`Curvature`,
                     Data_2_KMT_Local_Curv$Relative_Position),
        Data_3 = cor(Data_3_KMT_Local_Curv$`Curvature`,
                     Data_3_KMT_Local_Curv$Relative_Position),
        AVG = cor(Tortuosity_local_avg$Curvature,
...
###############################################################################
# Combind data for average #
Area_avg <- rbind(Data_1_Fiber_Area,
                  Data_2_Fiber_Area,
                  Data_3_Fiber_Area)
...
###############################################################################
# Combind data for average #
KMT_Minus_End_Interaction_25 <- rbind(Data_1_KMT_Minus_End_0.025,
                                      Data_2_KMT_Minus_End_0.025,
                                      Data_3_KMT_Minus_End_0.025)
KMT_Minus_End_Interaction_30 <- rbind(Data_1_KMT_Minus_End_0.03,
                                      Data_2_KMT_Minus_End_0.03,
                                      Data_3_KMT_Minus_End_0.03)
KMT_Minus_End_Interaction_35 <- rbind(Data_1_KMT_Minus_End_0.035,
                                      Data_2_KMT_Minus_End_0.035,
                                      Data_3_KMT_Minus_End_0.035)
KMT_Minus_End_Interaction_45 <- rbind(Data_1_KMT_Minus_End_0.045,
                                      Data_2_KMT_Minus_End_0.045,
                                      Data_3_KMT_Minus_End_0.045)
KMT_Minus_End_Interaction_50 <- rbind(Data_1_KMT_Minus_End_0.05,
                                      ata_2_KMT_Minus_End_0.05,
                                      Data_3_KMT_Minus_End_0.05)
KMT_Minus_End_Interaction_75 <- rbind(Data_1_KMT_Minus_End_0.075,
                                      Data_2_KMT_Minus_End_0.075,
                                      Data_3_KMT_Minus_End_0.075)
KMT_Minus_End_Interaction_100 <- rbind(Data_1_KMT_Minus_End_0.1,
