...
Inter_Kinetochore_Dist <- function() {
    ...
    for (i in which(colnames(Segments) == "Pole1_00"):
        ...
        tryCatch(
        {
            ...
            if (!exists("DF_Pole1") || !exists("DF_Pole2")) {
                Inter_Kinetochore_Distance[i, 1] <- NA
                break
            }
            else {
                ...
                positions <- sqrt((Plus_end_1[1, 1] - Plus_end_2[1, 1])^2 +
                                          (Plus_end_1[1, 2] - Plus_end_2[1, 2])^2 +
                                          (Plus_end_1[1, 3] - Plus_end_2[1, 3])^2)
