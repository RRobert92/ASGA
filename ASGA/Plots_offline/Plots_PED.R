...
j = 1 
while (i >= -0.2){
  FA_bin_100[j,1] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "100%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "100%"),],
                                                                                                 Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  FA_bin_80[j,1] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "50%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "50%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  FA_bin_45[j,1] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "25%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "25%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  
  FA_bin_100[j,2] <- sd(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "100%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "100%"),],
                                                                                             Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  FA_bin_80[j,2] <- sd(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "50%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "50%"),],
                                                                                           Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  FA_bin_45[j,2] <- sd(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "25%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "25%"),],
                                                                                           Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][2]))
  
  FA_bin_100[j,3] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "100%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "100%"),],
                                                                                                 Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][1]))
  FA_bin_80[j,3] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "50%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "50%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][1]))
  FA_bin_45[j,3] <- median(as.matrix(All_fiber_area[with(All_fiber_area, `V1` == "25%"),][with(All_fiber_area[with(All_fiber_area, `V1` == "25%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][1]))
  j = j + 1
  i = i - 0.1
}
...
j = 1 
while (i >= -0.2){
  ND_bin_100[j,1] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),],
                                                                                                 Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  ND_bin_80[j,1] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  ND_bin_45[j,1] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  
  ND_bin_100[j,2] <- sd(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),],
                                                                                             Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  ND_bin_80[j,2] <- sd(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),],
                                                                                           Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  ND_bin_45[j,2] <- sd(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),],
                                                                                           Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][3]))
  
  ND_bin_100[j,3] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "100%"),],
                                                                                                 Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][6]))
  ND_bin_80[j,3] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "50%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][6]))
  ND_bin_45[j,3] <- median(as.matrix(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),][with(All_fiber_focus[with(All_fiber_focus, `V1` == "25%"),],
                                                                                               Relative_position <= i & Relative_position >= as.numeric(i-0.1)),][6]))
  j = j + 1
  i = i - 0.1
}
